...
function Toggle() {
  ...
  return (
    <div className="  second-sec h-auto p-5">
        ...
        {data.map((item, i) => {
          ...
          return (
            <div key={item.key} className="mb-2">
              <div
                className="h3-title p-4 d-flex justify-content-between"
                onClick={() => toggle(i)}
              >
              ...
              <div
                className={
                  state === i
                    ? "content-item mt-1 p-4 "
                    : "content-item mt-1 p-4 d-none"
                }
              >
                <h6 className="text-white lh-lg    m-3">{item.content}</h6>
              </div>
            </div>
          );
        })}
